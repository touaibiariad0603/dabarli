...
export declare const AKS_CLUSTER_RESOURCE_ID = "CLUSTER_RESOURCE_ID";
export declare const AKS_METADATA_FILE_PATH = "/etc/kubernetes/aks-cluster-metadata";
 ...
 */
export declare function extractClusterNameFromResourceId(resourceId: string): string | undefined;
