...
declare namespace InngestExecution_d_exports {
  export { BasicFoundStep, ExecutionResult, ExecutionResultHandler, ExecutionResultHandlers, ExecutionResults, ExecutionVersion, IInngestExecution, InngestExecution, InngestExecutionFactory, InngestExecutionOptions, MemoizedOp, PREFERRED_ASYNC_EXECUTION_VERSION, PREFERRED_CHECKPOINTING_EXECUTION_VERSION };
}
/**
 ...
 */
declare const PREFERRED_ASYNC_EXECUTION_VERSION = ExecutionVersion.V1;
/**
 * The preferred execution version that will be used by the SDK when handling
 ...
 * new runs, not existing ones.
 */
declare const PREFERRED_CHECKPOINTING_EXECUTION_VERSION = ExecutionVersion.V2;
/**
