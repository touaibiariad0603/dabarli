...
const ProductDetailScreen = () => {
  ...
  return (
    <SafeScreen>
      ...
      >
        ...
        <View className="p-6">
          ...
          <View className="flex-row items-center mb-6">
            <Text className="text-primary text-4xl font-bold">{product.price.toFixed(2)}dz</Text>
          </View>
      ...
      {/* Bottom Action Bar */}
      <View className="absolute bottom-0 left-0 right-0 bg-background/95 backdrop-blur-xl border-t border-surface px-6 py-4 pb-12">
        <View className="flex-row items-center gap-3">
          <View className="flex-1">
            <Text className="text-text-secondary text-sm mb-1">Total Price</Text>
            <Text className="text-primary text-2xl font-bold">
              {(product.price * quantity).toFixed(2)}dz
            </Text>
          </View>
          <TouchableOpacity
    ...
    <SafeScreen>
      <View className="flex-1 items-center justify-center px-6">
        ...
        <Text className="text-text-secondary text-center mt-2">
          This product may have been removed or doesnt exist
        </Text>
        <TouchableOpacity
